...
class NaiveExperienceMaker(ABC):
    ...
    @torch.no_grad()
    def make_experience_list(self, all_prompts: Union[str, List[str]], for_eval=False, **generate_kwargs) -> List[Experience]:
        """
        ...
        s = time.time()
        samples_list = self.generate_samples(all_prompts, for_eval=for_eval, **generate_kwargs)
    ...
    @torch.no_grad()
    def generate_samples(self, all_prompts: List[str], for_eval=False, **generate_kwargs) -> List[Samples]:
        """
...
class RemoteExperienceMaker(NaiveExperienceMaker):
    ...
    def make_experience_list(self, all_prompts: Union[str, List[str]], for_eval=False, **generate_kwargs) -> List[Experience]:
        ...
        experiences = super().make_experience_list(all_prompts, for_eval=for_eval, **generate_kwargs)
        if self.critic is not None:
    ...
    def _generate_vllm(self, all_prompts: List[str], for_eval=False, **kwargs) -> List[Samples]:
